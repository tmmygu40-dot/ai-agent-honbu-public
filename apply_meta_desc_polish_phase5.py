...
# -*- coding: utf-8 -*-
"""
apply_meta_desc_polish_phase5.py - 既存アプリ meta description 改善 Phase 5（残り481件 batch）

Phase 1+2b+3 で計500件改善済み。Phase 5 は次の500件（Phase3より大きい batch）を対象に
...
# 一般領域 variation（18種・Phase 3の10種 + Phase 5新規8種）
GENERAL_VARIATIONS = [
    # Phase 3継承（10種）
...
def main():
    ...
    target = cands[PHASE5_SKIP: PHASE5_SKIP + PHASE5_LIMIT]
    ...
    report_path = OUT_DIR / "meta_desc_polish_phase5_report.md"
    json_path = OUT_DIR / "meta_desc_polish_phase5_result.json"
    ...
    print(f"=== Phase 5 {'DRY-RUN' if dry else 'EXECUTE'} 完了 ===")
