...
X_TEMPLATES_BY_KIND: dict[str, list[tuple[str, str, str]]] = {
    "moveout": [
        (
            "退去費用、想定より高くなりそうですか？",
            "敷金や原状回復の負担感を、入力ベースでざっくり確認できます。",
            "金額を断定せず、判断の目安として使えるチェックです。",
        ),
        (
            "引っ越し後の請求、どこまで見込んでいますか？",
            "退去時に気になりやすい費用をまとめて比較できます。",
            "最終額を決めるものではなく、判断材料づくり向けです。",
        ),
    ],
    "living_cost": [
        (
            "毎月の生活費、想定内に収まっていますか？",
            "固定費と変動費のバランスを短時間で見直せます。",
            "家計改善の方向を考えるための目安として使えます。",
        ),
        (
            "生活コスト、どこから見直すのが効率的？",
            "支出の偏りをチェックして優先順位を整理できます。",
            "断定せず、次の一手を考える判断材料としてどうぞ。",
        ),
    ],
    "insurance": [
        (
            "その保険、いまの状況に合っていますか？",
            "補償内容と見直しポイントを手早く確認できます。",
            "契約判断を断定せず、比較の目安として使えます。",
        ),
        (
            "保険の見直し、後回しになっていませんか？",
            "気になる補償の重複や不足を整理できます。",
            "結論を決める用途ではなく、判断材料づくり向けです。",
        ),
    ],
    "tax": [
        (
            "税金の負担、今年はどれくらいを想定していますか？",
            "住民税や手取りの変化をざっくり確認できます。",
            "断定せず、見通しを立てるための目安として使えます。",
        ),
        (
            "通知が来る前に、税負担の準備できていますか？",
            "入力ベースでおおよその影響を把握できます。",
            "正式な金額ではなく、判断材料としてご活用ください。",
        ),
    ],
    "household": [
        (
            "値上げ続き、家計にどれくらい響いていますか？",
            "食費や固定費の増加分をまとめて確認できます。",
            "断定せず、見直し判断の目安として使える内容です。",
        ),
        (
            "家計の負担増、体感だけで判断していませんか？",
            "支出の変化を数字で整理して優先順位をつけられます。",
            "結論を急がず、判断材料をそろえる用途に向いています。",
        ),
    ],
    "disaster": [
        (
            "防災準備、いまのままで安心できますか？",
            "備えの抜け漏れを短時間で確認できます。",
            "断定せず、必要な行動を考える目安として使えます。",
        ),
        (
            "災害時の備え、家族分まで想定できていますか？",
            "優先して準備する項目を整理できます。",
            "最終判断の前に、現状確認の材料としてどうぞ。",
        ),
    ],
    "default": [
        (
            "気になるテーマ、後回しになっていませんか？",
            "短時間で現状を整理して次の行動を考えられます。",
            "断定せず、判断材料をそろえるためのチェックです。",
        ),
        (
            "その判断、情報不足のまま進めていませんか？",
            "まずは入力ベースで目安をつかめます。",
            "結論を決める前の確認ステップとして使えます。",
        ),
    ],
}
